...
save(trees, file = '1_data/2_processed/tmp/9.0.2_tmp_trees.rdata')
...
save(plots_metrics, file = '1_data/2_processed/tmp/9.0.2_tmp_plots_metrics.rdata')
print('Plots metrics calculated!')
...
save(plots_Ho, file = '1_data/2_processed/tmp/9.0.2_tmp_plots_Ho.rdata')
print('Plots Ho calculated!')
...
save(plots_Do, file = '1_data/2_processed/tmp/9.0.2_tmp_plots_Do.rdata')
print('Plots Do calculated!')
...
save(plots_sp, file = '1_data/2_processed/tmp/9.0.2_tmp_plots_sp.rdata')
print('Plots variables by species calculated!')
...
save(plots_status, file = '1_data/2_processed/tmp/9.0.2_tmp_plots_status.rdata')
print('Plots variables by status calculated!')
...
save(plots, file = '1_data/2_processed/tmp/9.0.2_tmp_plots_merged.rdata')
print('Plots merged!')
...
save(trees, plots, file = "1_data/2_processed/9.0.2_sfni_forest_data.rdata")
