...
source('/home/aitorvazquez/WorldClim/scripts/wc_historic_monthly_data.R')
source('/home/aitorvazquez/WorldClim/scripts/wc_climate_index.R')
...
folder_path <- "/home/aitorvazquez/WorldClim/historical_monthly_data/"
...
source('/home/aitorvazquez/WorldClim/scripts/wc_future_MIROC6_data.R')

# select SSPs (all or just 1)
SSPs <- c(1, 2, 3, 5)
# SSPs <- 2  # middle on the road
for(ssp in SSPs){
  
  # select data folder
  folder_path <- paste('/home/aitorvazquez/WorldClim/MIROC6_SSP', ssp, '/', sep = '')
