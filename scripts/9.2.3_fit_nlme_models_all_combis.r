...
# models_list <- c("elmamoun_2013_M18", "elmamoun_2013_M13") # the other were previously executed
...
for(model_name in models_list){
  ...
  model_results <- list()
  metrics <- tibble(model_name = numeric(), n_re_combi = numeric(),n_fe_combi = numeric(),
