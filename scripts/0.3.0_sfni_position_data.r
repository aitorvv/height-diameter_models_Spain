...
# Step 3: (a) calculate tree and plot variables related to position
#
...
plots <- plots[!duplicated(plots$IFN_PLOT_ID), ]
...
# save data
save(trees, plots, file = "1_data/2_processed/tmp/0.3_sfni_position_data.rdata")
