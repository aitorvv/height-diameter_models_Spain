...
load('1_data/2_processed/2.3_fit_nlme_models_by_species-logistic_model-best_combi.rdata')
...
# save results
save(all_adapted_dfs, model_results, metrics, sp_list, file = '1_data/2_processed/2.4_fit_nlme_models_by_species-logistic_model-all_models.rdata')
...
save(df, df_adapted, sp_list, metrics, best_model,
     file = '1_data/2_processed/2.4_fit_nlme_models_by_species-logistic_model-best_models.rdata')
